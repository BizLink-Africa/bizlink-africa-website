...
import { REQUESTED_SOLUTIONS, PREFERRED_CONTACT_METHODS, labelFor, type Inquiry } from '@/data/inquiries';
...
export default async function InquiryDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [{ data, error }, { data: linkedClient }, { data: checklist }] = await Promise.all([
  ...
  return (
    <div>
      ...
      <div className="mt-4 flex items-start justify-between flex-wrap gap-4">
        <div>
          <h1 className="font-[Geist,sans-serif] font-bold text-2xl text-[#00342b]">{inquiry.full_name}</h1>
      ...
      <div className="mt-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white border border-[#bfc9c4] p-6 space-y-5">
          <h2 className="font-[Geist,sans-serif] font-semibold text-[#00342b]">Inquiry Details</h2>
        ...
        <div className="space-y-6">
          <InquiryDetailForm
            ...
            initialAssignedTo={inquiry.assigned_to ?? ''}
          />
