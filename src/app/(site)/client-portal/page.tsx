...
import { CLIENT_PORTAL_SECTIONS } from '@/data/website';
...
const DEMO_ACTIVITY = [
  ...
  { time: '09:15 AM', event: 'Payment of TZS 450,000 collected via approved partner', type: 'payment', location: 'Client wallet' },
                ...
                <div className="border-t border-[#efeded] pt-5">
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="flex justify-between items-center">
                      <span className="text-xs text-[#3f4945]">This Month (via partner)</span>
                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-xs text-[#3f4945]">Settled to your wallet</span>
                  ...
                  <div className="mt-3 flex items-start gap-2 bg-[#afefdd]/20 p-3">
                    ...
                    <p className="text-[11px] text-[#065043] leading-relaxed">All funds settled directly to your merchant wallet by the approved payment partner.</p>
                  </div>
                </div>
        ...
        <div className="max-w-[1280px] mx-auto px-6 md:px-12">
          <div className="border border-[#afefdd] bg-[#afefdd]/10 p-6 flex items-start gap-4">
            ...
            <p className="text-sm text-[#3f4945] leading-relaxed">
              ...
              BizLink Africa Limited does not hold, receive, control, or settle client funds. Settlement is handled directly by the approved payment partner.
            </p>
          </div>
        </div>
      </section>
