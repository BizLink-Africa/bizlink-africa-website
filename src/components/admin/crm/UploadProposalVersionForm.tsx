...
import { uploadProposalVersion } from '@/app/admin/(protected)/crm/proposals/actions';

export default function UploadProposalVersionForm({ proposalId }: { proposalId: string }) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const result = await uploadProposalVersion(proposalId, formData);
    setSubmitting(false);
