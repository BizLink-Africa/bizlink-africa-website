...
import { setWorkflowActive } from '@/app/admin/(protected)/governance/approval-workflows/actions';

export default function WorkflowActiveToggle({ id, isActive }: { id: string; isActive: boolean }) {
