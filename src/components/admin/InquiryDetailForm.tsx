...
export default function InquiryDetailForm({
  ...
  return (
    <div className="bg-white border border-[#bfc9c4] p-6 space-y-5">
      <h2 className="font-[Geist,sans-serif] font-semibold text-[#00342b]">Admin Actions</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          <label className="block text-xs font-semibold text-[#707975] uppercase tracking-wider mb-1" htmlFor="assignedTo">
            Assigned To
          </label>
          <input
            id="assignedTo"
